...
def procesar_y_ajustar_pdf(ingresos, despachos, vehiculos, mermas, humedades, temperaturas, ruta_membrete, ruta_logo, usar_franja, tmpdir):
    pdf = FPDF()
...
if st.button("🚀 COMPILAR INFORME OFICIAL PDF", type="primary"):
    if not (fotos_ingreso or fotos_despacho or fotos_vehiculos or fotos_mermas or fotos_humedad or fotos_temp):
        ...
        with st.spinner("Construyendo informe corporativo..."):
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                # LÓGICA DE MEMBRETE: Prioriza el subido manual, sino busca el predeterminado
                ...
                if hoja_membrete:
                    ...
                    # Busca predeterminado en .png o .jpg
                ...
                # LÓGICA DE LOGO: Prioriza el subido manual, sino busca el predeterminado
